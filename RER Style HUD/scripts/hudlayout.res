...
"Resource/HudLayout.res"
{
	...
	HudWeaponSelection	// Controls the Weapon Panel Selector
	{
		...
		"PrimaryAmmoXPos"	"25"  [!$DECK]
		"PrimaryAmmoYPos"	"8" [!$DECK]
		"PrimaryAmmoXPos"	"25"  [$DECK]
		"PrimaryAmmoYPos"	"8" [$DECK]
		
		// Reserve Primary Ammo Position
		"ReserveAmmoXPos"	"62" [!$DECK]
		"ReserveAmmoYPos"	"8" [!$DECK]
		"ReserveAmmoXPos"	"62" [$DECK]
		"ReserveAmmoYPos"	"8" [$DECK]	
		
		// Bullet Icon Position and Size
		"AmmoIconXPos"	"64" [!$DECK]
		"AmmoIconYPos"	"5" [!$DECK]
		"AmmoIconXPos"	"64" [$DECK]
		"AmmoIconYPos"	"5" [$DECK]
		
		"AmmoIconSize"	"18" [!$DECK]	// wide and tall
		"AmmoIconSize"	"18" [$DECK]	// wide and tall
		
		// Primary Weapon Icon Size
		"PrimaryWeaponWide"		"30" [!$DECK]
		"PrimaryWeaponTall"		"10" [!$DECK]
		"PrimaryWeaponWide"		"30" [$DECK]
		"PrimaryWeaponTall"		"10" [$DECK]
		...
		// Primary Weapon Font
		"PrimaryAmmoFont"		"SurvivalNumbers"		// Primary Weapon Current Ammo Count Font
		"ReserveAmmoFont"		"PlayerDisplayName"	// Primary Weapon Reserve Ammo Count Font		
		"PistolAmmoFont"		"PlayerDisplayName"		// Secondary Weapon Ammo Count Font
