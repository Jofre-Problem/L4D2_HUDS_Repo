...
"Resource/HudLayout.res"
{
	...
	HudWeaponSelection	// Controls the weapon panel.
	{
		...
		"IconSize"		"-50" [!$DECK]	// square weapon icon sizes // 24
		"IconSize"		"-50" [$DECK]	// square weapon icon sizes // 30
		...
		"SelectedItemColor"				"18 138 250 255"	// Selected Primary Weapon Icon and Primary Ammo Count Color 
		"SelectedReserveAmmoColor"		"18 138 250 255"	// Selected Reserve Ammo Count Color
		
		// Items Silhoutte Color
		"InactiveItemColor"		"166 74 1 255"		[$WIN32]
		"InactiveItemColor"		"166 74 1 255"		[$X360]
	...
	HudCloseCaption // Controls the caption box
	{
	...
	CHudTeamDisplay	// Controls the teamdisplayhud.res
	{
