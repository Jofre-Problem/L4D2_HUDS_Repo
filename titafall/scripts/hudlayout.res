...
"Resource/HudLayout.res"
{
	...
	HudDamageIndicator
	{
		...
		"MinimumWidth" "70" // "40" default
		"MaximumWidth" "70" // "80" default
		"StartRadius" "40" // "120" default
		"EndRadius" "40" // "80" default
		"MinimumHeight" "30" // "30" default
		"MaximumHeight" "30" // "60" default
		"MinimumTime" "2"
	...
	HudWeaponSelection
	{
		...
		"xpos"	"c-35" [!($X360WIDE || $WIN32WIDE)]
		"xpos"			"285" [$X360WIDE || $WIN32WIDE] 
		// "c-35" if localplayerpanelres.primaryweaponbox.xpos is centered
		"ypos"	"r73"
		"zpos"	"50"
		"wide"	"80"
		"tall"	"155"
		...
		"MeleeWeaponX"		"2"
		"MeleeWeaponY"		"0"
		"MeleeWeaponWide"	"20" // "23" // "49"
		"MeleeWeaponTall"	"10" // "22"	
		...
		"ChainsawBarY"		"0"
		"ChainsawBarWide"	"3" // "5"
		"ChainsawBarTall"	"10" // "19"		
				
		"PrimaryAmmoXPos"	"26" //"22"
		"PrimaryAmmoYPos"	"7" // "0"
		"ReserveAmmoXPos"	"49" // "50" // "22"
		"ReserveAmmoYPos"	"12" // "14"	
		
		"AmmoIconXPos"	"-13" // 28 // "25" // "20"
		"AmmoIconYPos"	"9999" // "3" // "-8" // "3"
		...
		"PrimaryWeaponsYPos"	"10"	
		"PrimaryWeaponWide"		"55" // "0" // "60"
		"PrimaryWeaponTall"		"18" // "0" // "20"
		...
		"RightSideIndent"	"10" // "10"
		"IconSize"		"-999" // "24"	// square weapon icon sizes			
		
		"PrimaryAmmoFont"		"HudAmmo"
		"ReserveAmmoFont"		"HudAmmoSmall" 
		"PistolAmmoFont"		"HudAmmoSmall" 
		
		"SelectedItemColor"				"255 255 255 255" // Selected Primary Weapon Icon, Primary Ammo Count, Ammo Icon and Special Ammo Icon Color 
		"UnselectedItemColor"			"200 200 200 50" // Apex Legends gray 
		"SelectedReserveAmmoColor"		"169 169 169 255" // Selected Reserve Ammo Count Color
		"UnselectedReserveAmmoColor"	"169 169 169 255" // Unselected Reserve Ammo Count Color

		// Items Silhoutte Color
		"InactiveItemColor"		"200 200 200 50"		[$WIN32]
		"InactiveItemColor"		"200 200 200 50"		[$X360]
	...
	HudCloseCaption
	{
		...
		"visible"	"1"
		"enabled"	"1"
		"xpos"		"c-200" [$X360WIDE || $WIN32WIDE]
		"xpos"		"c-150" [!($X360WIDE || $WIN32WIDE)] // "c-150" when wide == 300
		"ypos"		"r200"	[$WIN32] // r200 is the actual titanfall and apex value. default l4d2 values "r220"	[$WIN32], "r230"	[$X360]
		"ypos"		"r200"	[$X360] // r200 is the actual titanfall and apex value. default l4d2 values "r220"	[$WIN32], "r230"	[$X360]
		"wide"		"400" [$X360WIDE || $WIN32WIDE]
		"wide"		"300" [!($X360WIDE || $WIN32WIDE)] // 400 is the actual titanfall and apex value. default l4d2 value "300"
		"tall"		"135"
		"usetitlesafe"	"1"
		...
		"GrowTime"		"0.125"	// 0.25
		"ItemHiddenTime"	"0.1"  // Nearly same as grow time so that the item doesn't start to show until growth is finished. 0.2 default
		"ItemFadeInTime"	"0.1"	// Once ItemHiddenTime is finished, takes this much longer to fade in. 0.15 default
		"ItemFadeOutTime"	0.3
		"topoffset"		"0"
	}
	...
	// Infected health, for the... infected player only, it seems.
	"HudZombieHealth"
	{
		"fieldName"		"HudZombieHealth"
		"xpos"			"30" // "r387" default
		"ypos"			"r90" // "r100"
		"wide"			"400" // "400"
		"tall"			"100" // "100"
		"visible"		"1"
	...
	CHudLocalPlayerDisplay // (Hey, you, modder! Don't touch this if you want to keep custom crosshair support)
	{
		...
		// ALL ZERO FOR CUSTOM CROSSHAIR SUPPORT
		"xpos"		"0"
		"ypos"		"0"
		"wide"		"f0"
		"tall"		"f0"
