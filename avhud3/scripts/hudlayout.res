...
"Resource/HudLayout.res"
{
	...
	HudWeaponSelection
	{
		...
		"PrimaryWeaponsYPos"	"13"	
		"PrimaryWeaponBoxWide"	"53" [!$DECK] //53
		"PrimaryWeaponBoxTall"	"28" [!$DECK] //28
		...
		//the m60 ammo counter for whatever reason is a entirely separate thing and is not affected by whatever values below. valve pls fix
		"PrimaryAmmoXPos"	"20"  [!$DECK] //22
		"PrimaryAmmoYPos"	"7" [!$DECK] //0
		"ReserveAmmoXPos"	"40" [!$DECK] //22
		"ReserveAmmoYPos"	"10" [!$DECK] //14
		...
		"AmmoIconXPos"	"36" [!$DECK] //20
		"AmmoIconYPos"	"6" [!$DECK] //3
		"AmmoIconSize"	"19" [!$DECK]	// wide and tall
		"AmmoIconXPos"	"24" [$DECK]
		"AmmoIconYPos"	"3" [$DECK]
		"AmmoIconSize"	"28" [$DECK]	// wide and tall
		
		"SpecialAmmoXPos"	"29" //same as ammoicon pos
		"SpecialAmmoYPos"	"4"
				
		"PrimaryWeaponWide"		"65" [!$DECK] //60
		"PrimaryWeaponTall"		"25" [!$DECK] //20
		...
		"PrimaryAmmoFont"		"OuttroStatsCrawlTitles" //HudAmmo
		"ReserveAmmoFont"		"PlayerDisplayNameSmall"	//HudAmmoSmall	
		"PistolAmmoFont"		"OuttroStatsCrawlTitles" //HudAmmo
		
		"SelectedItemColor"				"3 178 46 255" //142 214 57 255
		"UnselectedItemColor"			"White"
		"SelectedReserveAmmoColor"		"2 135 33 255" //93 142 32 255
		"UnselectedReserveAmmoColor"	"169 169 169 255" //169 169 169 255
		
		"InactiveItemColor"		"64 64 64 192" [$WIN32]
		"InactiveItemColor"		"64 64 64 192"		  [$X360]
	...
	CHudTeamDisplay
	{
		...
		"if_split_screen_horizontal"
		{
			"ypos"	"c-462"		 //adjusted by Big Boss
		}
