...
"Resource/HudLayout.res"
{
	...
	HudWeaponSelection	// Controls the Weapon Panel Selector
	{
		...
		// Melee Icon Size
		"MeleeWeaponWide"	"44" [!$DECK]
		"MeleeWeaponTall"	"19" [!$DECK]	
		"MeleeWeaponWide"	"44" [$DECK]
		"MeleeWeaponTall"	"19" [$DECK]
		...
		// Chainsaw Icon Size
		"ChainsawWide"		"37" 	[!$DECK]
		"ChainsawTall"		"16"	[!$DECK]
		"ChainsawWide"		"37" 	[$DECK]
		"ChainsawTall"		"16"	[$DECK]
		...
		"ChainsawBarWide"	"4"		[!$DECK]
		"ChainsawBarWide"	"4"		[$DECK]
		"ChainsawBarTall"	"15"	[!$DECK]	
		"ChainsawBarTall"	"15"	[$DECK]	
		...
		"PrimaryAmmoYPos"	"7" [!$DECK]
		"PrimaryAmmoXPos"	"22"  [$DECK]
		"PrimaryAmmoYPos"	"7" [$DECK]
		
		// Reserve Primary Ammo Position
		"ReserveAmmoXPos"	"42" [!$DECK]
		"ReserveAmmoYPos"	"12" [!$DECK]
		"ReserveAmmoXPos"	"42" [$DECK]
		"ReserveAmmoYPos"	"12" [$DECK]	
		
		// Bullet Icon Position and Size
		"AmmoIconXPos"	"40" [!$DECK]
		"AmmoIconYPos"	"12" [!$DECK]
		"AmmoIconXPos"	"40" [$DECK]
		"AmmoIconYPos"	"12" [$DECK]
		
		"AmmoIconSize"	"12" [!$DECK]	// wide and tall
		"AmmoIconSize"	"12" [$DECK]	// wide and tall
		
		// Primary Weapon Icon Size
		"PrimaryWeaponWide"		"0" [!$DECK]
		"PrimaryWeaponTall"		"0" [!$DECK]
		"PrimaryWeaponWide"		"0" [$DECK]
		"PrimaryWeaponTall"		"0" [$DECK]
		...
		"PistolBoxTall"	"20" [!$DECK]
		"PistolBoxWide"	"53" [$DECK]
		"PistolBoxTall"	"20" [$DECK]
		
		// Items Silhoutte Icon Size
		"IconSize"		"-512" [!$DECK]	// square weapon icon sizes			
		"IconSize"		"-512" [$DECK]	// square weapon icon sizesw			
		
		// Primary Weapon Font
		"PrimaryAmmoFont"		"HudAmmo"		// Primary Weapon Current Ammo Count Font
		"ReserveAmmoFont"		"HudAmmoSmall"	// Primary Weapon Reserve Ammo Count Font		
		"PistolAmmoFont"		"HudAmmo"		// Secondary Weapon Ammo Count Font
		
		<!--			COLORS START				-->
		
		// Icon Color When Selected and Unselected
		"SelectedItemColor"				"142 214 57 255"	// Selected Primary Weapon Icon and Primary Ammo Count Color 
		"SelectedReserveAmmoColor"		"93 142 32 255"		// Selected Reserve Ammo Count Color
		...
		// Special Ammo Icon Position, for some reason, these have to be at the end in order to work.
		"SpecialAmmoXPos"	"37"
		"SpecialAmmoYPos"	"11"
	}
