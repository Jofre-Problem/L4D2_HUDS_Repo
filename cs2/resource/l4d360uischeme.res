/////////////////////////////////////////////////////////
// Urik: replace Stratum2-Bold with <your font name>
//------------------------------------------------------------------------------------------------------------------------------------------------------
//
...
Scheme
{
	...
	// Custom styles for use with L4D360HybridButtons
		...
		HybridButton.BorderColor					"065 086 109 255"//selected1color	urik: this the border color for l4d2 hubrid buttons (all menu/submenu selections). This... should be brighter than BlotchColor (selected2color)
		HybridButton.BlotchColor					"042 055 070 255"//selected2color	urik: this the inside-fill color for l4d2 hubrid buttons (all menu/submenu selections). This... should be darker (or, perhaps, more transparent) than BorderColor (selected1color)
	...
	CustomFontFiles
	{
		...
		"2"		"resource/stratum2medium.vfont"
		"3"		"resource/stratum2bold.vfont"
	}
