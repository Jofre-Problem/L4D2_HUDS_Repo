...
// Urik: replace Stratum2-Medium with <your font name>
//------------------------------------------------------------------------------------------------------------------------------------------------------
//
...
Scheme
{
	...
	Fonts
	{
		...
		"DamageNotification"//depreciated since Urik HUD v4 and Simple Hud 
		{
			"1"
			{
				"name"		"Stratum2-Medium"
		...
		HudAmmo
		{
			...
			{
				"name"		"Stratum2-Medium"
				"tall"		"19"//HudAmmo, default is 18
				"weight"	"0"
				"additive"	"1"
				"antialias" "1"
				//"scanlines"	"1"//Urik: scanlines anyone?
			}
		}
		...
		"TargetID"
		// Urik: 
		// even though I usually use themed font here, for L4D1 (Trade Gothic) version here I decided to keep my previously used Verdana.
		{
			"1"
			{
				"name"			"Stratum2-Medium"	//was stubble bold by default, verdana by urik
				"tall"			"10"//TargetID (tall)
				"weight"		"400"//TargetID (weight)
				"antialias"		"1"
			}
		}
	...
	CustomFontFiles
	{
		...
		"7"		"resource/stratum2medium.vfont"
	}
}
