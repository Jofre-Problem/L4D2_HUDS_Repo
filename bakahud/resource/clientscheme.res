Scheme
{
	...
	Colors
	{
		...
		"VersusBrown"		"130 65 0 175"
		"VersusSelected"	"140 0 0 175"
		"VersusDarkGrey"	"0 0 0 175"
	...
	Fonts
	{
		...
		"PrimaryAmmoF"
		{
			"1"
			{
				"name"			"luoli" [($WIN32 && $WIN32HIDEF) || ($X360 && ($X360WIDE && $X360HIDEF))]
				"name"			"luoli" [($WIN32 && !$WIN32HIDEF) || ($X360 && !($X360WIDE && $X360HIDEF))]
				"tall"			"26"    [$WIN32]
				"weight"		"400"
		...
		HudNumbersSmall
		{
			"1"
			{
				"name"			"miaomiao" [($WIN32 && $WIN32HIDEF) || ($X360 && ($X360WIDE && $X360HIDEF))]
				"name"			"miaomiao" [($WIN32 && !$WIN32HIDEF) || ($X360 && !($X360WIDE && $X360HIDEF))]
				"tall"			"16"
				"weight"		"1000"
				"additive"		"1"
		...
		DebugOverlay
		{
			...
			{
				"name"			"luoli"
				"tall"			"8"		[$WIN32 || !($X360WIDE && $X360HIDEF)]
				"tall"			"8"		[$X360 && ($X360WIDE && $X360HIDEF)]
				"weight"		"200"		[$WIN32]
				"outline"		"1"		[$WIN32]
				"weight"		"700"		[$X360]
				"range"			"0x0000 0x017F" // Basic Latin, Latin-1 Supplement, Latin Extended-A
